...
export function VideoEditor() {
  ...
  const {
    ...
    videoDuration: regenVideoDuration,
  ...
  const {
    ...
    blendOverlap, blendContext, blendUseCut, setBlendInfo, setBlendContext, setBlendUseCut, updateBlendOverlap,
    ...
    regenVideoUrl, regenVideoPath, regenVideoDuration, regenImageUrl, regenImagePath,
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      {selectedGap && tracks[selectedGap.trackIndex]?.kind !== 'audio' && (
        <GapGenerationModal
          ...
          blendUseCut={blendUseCut}
          onBlendUseCutChange={setBlendUseCut}
        />
      )}
